  ...
  (0, _createClass3.default)(Aragog, [{
    ...
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(options) {
        var _config$options, _config$options$usern, username, _config$options$repos, repository, _config$options$query, queryConditions, selector, url, issueList;

        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _config$options = (0, _extends3.default)({}, this.config, options), _config$options$usern = _config$options.username, username = _config$options$usern === undefined ? '' : _config$options$usern, _config$options$repos = _config$options.repository, repository = _config$options$repos === undefined ? '' : _config$options$repos, _config$options$query = _config$options.queryConditions, queryConditions = _config$options$query === undefined ? {} : _config$options$query, selector = _config$options.selector;
              ...
              case 5:
                ...
                return this.page.evaluate(function (args) {
                  ...
                  var domList = document.querySelectorAll(selector || 'li[id^=issue_] a[href*="/' + username + '/' + repository + '/issues/"]');
                  var len = domList.length;
                  var list = [];
                  for (var i = 0; i < len; i++) {
                    var nextElement = domList[i].nextElementSibling;
                    var labels = [];
                    if (nextElement && nextElement.classList.contains('labels')) {
                      var labelDomList = nextElement ? nextElement.children : [];
                      var nums = labelDomList.length;
                  ...
                  return list;
                }, { username: username, repository: repository, selector: selector });
